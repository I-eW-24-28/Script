...
\begin{tikzpicture}
    ...
    \node[relationship, below right =of sus,
          ...
          pin={[key attribute]270:Matrikelnummer}] (ba) {besteht aus};
    \node[entity, above right =of ba,
          pin={[key attribute]90:Klassen ID}] (kl) {Klasse};
    \node[relationship, below right =of kl,
          pin={[key attribute]240:Fach ID},
          pin={[key attribute]300:Klassen ID}] (fu) {erhält Unterricht in};
    \node[entity, above right = of fu,
          pin={[key attribute]90:Fach ID}] (f) {Fach};
    \node[relationship, below right =of f,
          pin={[key attribute]270:Fach ID},
          pin={[key attribute]330:Personalnummer}] (u) {unterrichtet};
